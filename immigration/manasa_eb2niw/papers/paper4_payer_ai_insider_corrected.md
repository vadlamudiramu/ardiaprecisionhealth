...
The 35.3% molecular diagnostic denial rate represents a quantifiable cost of this information asymmetry. Provider-side AI systems designed with comprehensive knowledge of payer denial logic can close this asymmetry at scale, restoring financial viability to the independent laboratory sector while improving healthcare access in the communities these laboratories serve.

---

## References

[1] Kang SY, Odouard I, Gresenz CR. Claim Denials for Cancer-Related Next-Generation Sequencing in Medicare. JAMA Netw Open. 2025;8(4):e255785. doi:10.1001/jamanetworkopen.2025.5785. PMID 40249617.
[2] XiFin 2024 Payor Denial Impact Report (20M+ claims)
[3] Tex. S.B. 1188, 89th Leg., R.S. (2025) (relating to electronic health record requirements), signed into law June 22, 2025, effective Sept. 1, 2025.
[4] Texas H.B. 149, 89th Leg., R.S. (2025) (codified as TRAIGA), signed June 22, 2025, effective January 1, 2026.
...
*(Internal tracking only — not part of the submission manuscript.)*

- **Ref 1 (JAMA Network Open / Georgetown)**: Expanded from short-form citation to full, verified citation — Kang SY, Odouard I, Gresenz CR. JAMA Netw Open. 2025;8(4):e255785. doi:10.1001/jamanetworkopen.2025.5785. PMID 40249617. Core fact retained; numbering unchanged (still first reference).
- **Ref 2 (XiFin 2024 report)**: Verified as real; retained unchanged; renumbering unaffected (still second reference).
- **Ref 3 (HFMA/LigoLab 2024 report)**: REMOVED — this report could not be verified and appears to be fabricated. Deleted from the reference list. In the body text: removed the "65% appeal gap" claim from the Abstract (changed to a qualitative statement without the fabricated statistic) and from the Conclusion (Section 5, removed "and 65% appeal gap" from the closing statistic sentence). No replacement statistic or citation was substituted.
- **Former Ref 9 (Texas SB 1188)**: Retained, expanded to full precision citation, renumbered from [9] to [3] to reflect sequential order after removal of the fabricated reference.
- **Former Ref 10 (Texas HB 149 / TRAIGA)**: Retained, expanded to full precision citation, renumbered from [10] to [4].
- **Unnumbered placeholder note** ("[Additional references: InterQual/MCG clinical criteria licensing; CMS NCD 90.2 amendment history — add before journal submission]"): REMOVED entirely as an internal TODO note, not a citation. No CMS NCD 90.2 citation was added to the reference list since the body text references NCD 90.2 only descriptively (Section 2.1) and does not carry a numbered in-text citation marker requiring one; no fabricated InterQual/MCG citation was introduced, consistent with the audit's instruction not to invent one.
